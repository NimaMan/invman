...
_POLICY_ALIASES = {
    ...
    "linear_capped_direct_quantity": _dense_spec(
        "linear_capped_direct_quantity",
        policy_backbone="linear",
        policy_decoder="capped_direct_quantity",
    ),
    "linear_capped_positive_quantity": _dense_spec(
        "linear_capped_direct_quantity",
        policy_backbone="linear",
        policy_decoder="capped_direct_quantity",
    ),
    ...
    "nn_capped_direct_quantity": _dense_spec(
        "nn_capped_direct_quantity",
        policy_backbone="nn",
        policy_decoder="capped_direct_quantity",
        hidden_dim=(50,),
        activation="selu",
    ),
    "nn_capped_positive_quantity": _dense_spec(
        "nn_capped_direct_quantity",
        policy_backbone="nn",
        policy_decoder="capped_direct_quantity",
        hidden_dim=(50,),
    ...
    "linear_dual_index_delta_targets": _dense_spec(
        "linear_dual_index_delta_targets",
        policy_backbone="linear",
        policy_decoder="bounded_quantity",
        action_adapter="dual_index_delta_targets",
    ),
    "nn_dual_index_delta_targets": _dense_spec(
        "nn_dual_index_delta_targets",
        policy_backbone="nn",
        policy_decoder="bounded_quantity",
        hidden_dim=(16, 16),
        activation="selu",
    ...
    "linear_capped_dual_index_delta_targets": _dense_spec(
        "linear_capped_dual_index_delta_targets",
        policy_backbone="linear",
        policy_decoder="bounded_quantity",
        action_adapter="capped_dual_index_delta_targets",
    ),
    "nn_capped_dual_index_delta_targets": _dense_spec(
    ...
    "linear_capped_dual_index_delta_smallcap_targets": _dense_spec(
        "linear_capped_dual_index_delta_smallcap_targets",
        policy_backbone="linear",
        policy_decoder="bounded_quantity",
        action_adapter="capped_dual_index_delta_smallcap_targets",
    ),
    "nn_capped_dual_index_delta_smallcap_targets": _dense_spec(
        "nn_capped_dual_index_delta_smallcap_targets",
        policy_backbone="nn",
        policy_decoder="bounded_quantity",
        hidden_dim=(16, 16),
        activation="selu",
    ...
    "soft_tree_dual_index_delta_targets": _soft_tree_spec(
    ...
    "soft_tree_capped_dual_index_delta_targets": _soft_tree_spec(
    ...
    "soft_tree_capped_dual_index_delta_smallcap_targets": _soft_tree_spec(
    ...
    "soft_tree_axis_constant_capped_dual_index_delta_smallcap_targets": _soft_tree_spec(
