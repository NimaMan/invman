...
def normalize_policy_head(policy_head: str) -> str:
    aliases = {
        ...
        "unbounded_direct_quantity": "unbounded_direct_quantity",
        "raw_direct_quantity": "unbounded_direct_quantity",
        "unbounded_quantity": "unbounded_direct_quantity",
        ...
        "two_stage_unbounded_direct_quantity": "hard_gated_direct_quantity",
