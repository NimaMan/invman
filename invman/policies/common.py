...
def normalize_policy_head(policy_head: str) -> str:
    aliases = {
        ...
        "uncapped_direct_quantity": "uncapped_direct_quantity",
        "uncapped_softplus_quantity": "uncapped_direct_quantity",
        "uncapped_positive_quantity": "uncapped_direct_quantity",
