...
- **Paper alignment:** the paper table `tab:owmr-results` now carries the finalized 6-seed headline rows from `SEED_ROBUST_BENCHMARK_2026_06_06.md` (het-3 +4.63%, high-CV-10 +7.16%) and treats instance_14 as a tie.
