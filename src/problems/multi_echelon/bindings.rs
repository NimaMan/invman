...
pub fn register_py(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    crate::problems::multi_echelon::production_assembly_distribution_network::bindings::register_py(m)?;
    crate::problems::multi_echelon::serial::bindings::register_py(m)?;
    Ok(())
}
