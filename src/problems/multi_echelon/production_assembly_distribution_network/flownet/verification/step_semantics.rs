...
use crate::problems::multi_echelon::production_assembly_distribution_network::literature::VERIFICATION_PROBLEM_INSTANCE;
...
fn worked_state() -> crate::problems::multi_echelon::production_assembly_distribution_network::env::NetworkInventoryState {
    let worked = WORKED_TRANSITION_CASE;
    initialize_state(
        &worked_graph(),
...
pub fn verify_pairwise_base_stock_reference_action() -> bool {
    ...
    let base_stock =
        crate::problems::multi_echelon::production_assembly_distribution_network::finite_horizon_dp::evaluate_named_heuristic(
