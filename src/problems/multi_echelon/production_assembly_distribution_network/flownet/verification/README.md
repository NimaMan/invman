# production_assembly_distribution_network/flownet/verification

This folder checks that the `production_assembly_distribution_network` FlowNet formulation matches the current Rust
problem semantics.
