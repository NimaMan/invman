...
use crate::problems::multi_echelon::production_assembly_distribution_network::demand::{DemandDistributionKind, DemandModel};
use crate::problems::multi_echelon::production_assembly_distribution_network::env::{NetworkEdge, NetworkNodeMode};
use crate::problems::multi_echelon::production_assembly_distribution_network::flownet::formulation::PRODUCTION_ASSEMBLY_DISTRIBUTION_NETWORK_FLOWNET_NAME;
...
pub fn instance_from_reference(reference: &NetworkInventoryReferenceInstance) -> FlowNetInstance {
    FlowNetInstance {
        ...
        flownet_name: String::from(PRODUCTION_ASSEMBLY_DISTRIBUTION_NETWORK_FLOWNET_NAME),
        parameters: vec![
            FlowNetParameter {
...
pub fn verification_instance_from_reference(
    ...
    FlowNetInstance {
        name: String::from("production_assembly_distribution_network_exact_verification_reference"),
        flownet_name: String::from(PRODUCTION_ASSEMBLY_DISTRIBUTION_NETWORK_FLOWNET_NAME),
        parameters: vec![
            FlowNetParameter {
                name: String::from("num_nodes"),
