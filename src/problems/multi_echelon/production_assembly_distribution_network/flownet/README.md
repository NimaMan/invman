# production_assembly_distribution_network/flownet

This folder records the `production_assembly_distribution_network` family in the shared FlowNet language.
