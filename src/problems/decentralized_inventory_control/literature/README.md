...
- [PRIMARY_REFERENCE_INSTANCE](/home/nima/code/ml/invman/src/problems/decentralized_inventory_control/literature/references.rs)
...
- the reusable `env.rs` transition (the one the heuristics, exact DP, and learned soft-tree
  ...
  path, vs the closed-form `204`. See [verification/README.md](/home/nima/code/ml/invman/src/problems/decentralized_inventory_control/verification/README.md)
  for the measured numbers and root cause.
- Oroojlooy 2021 paper: background only, not carried as a repo benchmark row.

Use [references.rs](/home/nima/code/ml/invman/src/problems/decentralized_inventory_control/literature/references.rs) as the source of truth for:
