<!--
RESULTS_instance14.md — experiment log for the agentic_policy_search system on OWMR Kaynov
...
## Reproduce
```bash
# winner spec: agentic_policy_search/specs/winner_gen1_oblique_perret_linear.json
cd invman && RAYON_NUM_THREADS=4 OMP_NUM_THREADS=4 python agentic_policy_search/evaluate_policy_spec.py \
  --spec agentic_policy_search/specs/winner_gen1_oblique_perret_linear.json \
