// agentic_policy_search :: agent :: main.rs
// =================================================================================================
...
fn run() -> Result<(), String> {
    ...
    let gen0_session = SessionId::new("agentic_policy_search:gen0").map_err(|e| e.to_string())?;
    ...
    for g in 1..=cfg.generations {
        ...
        let sid = format!("agentic_policy_search:gen{g}");
...
fn print_summary(
    ...
    println!("================ agentic_policy_search :: summary ================");
    println!(
