...
def parse_args():
    parser = argparse.ArgumentParser(description="Run the clean L=4 fixed-cost lost-sales demand policy suite.")
    parser.add_argument("--run_tag", default="fixed_cost_l4_p4_k5_demand_policy_suite_clean_seed42")
...
def write_summary(summary, summary_json: Path, summary_md: Path):
    ...
    lines = [
        "# Fixed-Cost L4/P4/K5 Demand Policy Suite",
        "",
...
def build_args(parsed, results_dir: Path, logs_dir: Path, models_dir: Path, demand_case: str, demand_kwargs: dict, policy_name: str):
    ...
    args.horizon = 2000
    args.dynamic_horizon = False
    args.min_dynamic_horizon = 2000
    args.max_dynamic_horizon = 2000
...
def main():
    ...
    summary_json = root / "fixed_cost_l4_p4_k5_demand_policy_suite.json"
    summary_md = root / "fixed_cost_l4_p4_k5_demand_policy_suite.md"
    ...
    summary = {
        ...
        "reference_base": "lit_pois_mu5_l4_p4_k5",
        "lead_time": 4,
        "shortage_cost": 4.0,
