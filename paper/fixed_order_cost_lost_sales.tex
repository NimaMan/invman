...
$o_1(x_t),\ldots,o_{\bar q}(x_t)$, and sets
\[
\hat m(x_t) = \sum_{k=1}^{\bar q} \sigma(o_k(x_t)),
\qquad
...
a single hidden layer of width $H=50$ with SELU activation.
...
Linear soft-gated ordinal quantity & $(d+1)(\bar q+1)$ & $105 / 255$ \\
...
NN soft-gated ordinal quantity & $H(d+1) + (H+1)(\bar q+1)$ & $1321 / 2851$ \\
\hline
\end{tabular}
\end{table}
