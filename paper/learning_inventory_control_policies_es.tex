...
start off-gate and scatter widely, leaving the row only at parity (Section~\ref{sec:pirhoo-results}). To
fix this we introduce a \emph{residual gate-backbone} action head, a new action geometry in which the
learned policy outputs a signed correction \emph{around} the gate rather than the order itself:
\begin{equation}
