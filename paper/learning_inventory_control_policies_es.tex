...
Beyond the problems studied above, the same code base implements two further inventory environments
that we validate against the literature but do not train policies on in this paper. We record these
checks here because they bear on reproducibility --- the environment library reproduces published
benchmarks beyond the problems we report results for. Table~\ref{tab:additional-env-validation} covers
