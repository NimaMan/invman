...
per-node order-up-to coordinate system, reduces the long-run average cost to $8{,}034.8\pm17.6$, an improvement of $22.4\%$
...
per-node order-up-to design --- beats the reproduced benchmark by $\approx 37\%$ across two
