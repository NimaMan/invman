...
This is the fixed-order-cost counterpart to `lost_sales/README.md`.
...
2. Read these files for context:
   - `README.md`
   - `policy_search/README.md`
   - `policy_search/programs/fixed_order_cost/README.md`
...
6. Re-evaluate the promoted winner on a long horizon:
   - `python scripts/lost_sales/evaluate_saved_policy.py --problem lost_sales_fixed_order_cost --reference lit_pois_mu5_l4_p4_k5 --model_dir <model_dir> --eval_horizon 1000000 --eval_seeds 3`
