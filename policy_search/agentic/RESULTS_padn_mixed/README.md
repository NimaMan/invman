<!--
RESULTS_padn_mixed/README.md — experiment log for the policy_search/agentic system on the PADN
...
## Reproduce
```bash
cd invman && RAYON_NUM_THREADS=4 OMP_NUM_THREADS=4 python policy_search/agentic/evaluate_policy_spec_padn.py \
  --spec policy_search/agentic/specs/padn_explore_best.json \
