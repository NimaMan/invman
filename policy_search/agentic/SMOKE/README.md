<!--
=================================================================================================
SMOKE/README.md -- policy_search/agentic :: one-iteration end-to-end runbook + integration punch-list
=================================================================================================
ALGORITHMIC ROLE
  ...
  Codex emits, and the evaluate I/O JSON the oracle returns). SMOKE/README.md tells a human/integrator how
...
# policy_search/agentic — SMOKE runbook (one iteration, end-to-end)

Base dir (`<base>`): `/home/nima/code/ml/invman/policy_search/agentic`
...
python policy_search/agentic/evaluate_policy_spec.py \
  --spec policy_search/agentic/specs/gate_anchor_echelon_targets.json \
...
```bash
python policy_search/agentic/evaluate_policy_spec.py --spec policy_search/agentic/specs/bad_unknown_action_head.json     --instance 14 --seeds 5 --budget tiny   # unknown enum
python policy_search/agentic/evaluate_policy_spec.py --spec policy_search/agentic/specs/bad_symmetric_on_asymmetric.json --instance 14 --seeds 5 --budget tiny   # infeasible head on i14
```
Harness-precondition checks (**exit 2**, still a JSON on stdout):
```bash
python policy_search/agentic/evaluate_policy_spec.py --spec policy_search/agentic/specs/gate_anchor_echelon_targets.json --problem dual_sourcing --seeds 5 --budget tiny  # wrong problem
python policy_search/agentic/evaluate_policy_spec.py --spec policy_search/agentic/specs/gate_anchor_echelon_targets.json --instance 14 --seeds 3 --budget tiny             # <5 seeds
```
...
```bash
cd /home/nima/code/ml/invman/policy_search/agentic/agent
...
```
and on **stdout** the summary block (`================ policy_search/agentic :: summary ====...`)
