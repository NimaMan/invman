# ten_year_market_context_summary

Generated from the reproducible ten-year market context within the Hormuz history package.

## Key results

- Brent moved from `$37.77/b` on `2016-04-06` to `$127.61/b` on `2026-04-02`, a `237.9%` move across the `10.00`-year window.
- WTI moved from `$37.74/b` on `2016-04-06` to `$113.23/b` on `2026-04-02`, a `200.0%` move.
- Brent ranged from `$9.12/b` on `2020-04-21` to `$133.18/b` on `2022-03-08`. The latest Brent close sits at the `99.8` percentile of the window.
- WTI ranged from `$-36.98/b` on `2020-04-20` to `$123.64/b` on `2022-03-08`. The latest WTI close sits at the `99.1` percentile of the window.
...
- Ten-year oil-price context around the Hormuz disruption period.
...
```bash
python rust/src/case_studies/hormuz_strait/history/scripts/fetch_and_build.py
```
