...
pub const NETWORK_INVENTORY_FLOWNET_NAME: &str = "network_inventory";

pub fn canonical_network_inventory_flownet() -> FlowNetFormulation {
    FlowNetFormulation {
        name: String::from(NETWORK_INVENTORY_FLOWNET_NAME),
