...
- [classic_board_game.rs](/home/nima/code/ml/invman/rust/src/problems/decentralized_inventory_control/verification/classic_board_game.rs): exact Rust port of the public Edali & Yasarcan (2014) verification R code (closed-form board game; not the reusable env.rs)
