...
pub const GENERAL_NETWORK_FLOWNET_NAME: &str = "general_network";

pub fn canonical_general_network_flownet() -> FlowNetFormulation {
    FlowNetFormulation {
        name: String::from(GENERAL_NETWORK_FLOWNET_NAME),
