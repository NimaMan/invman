...
pub use formulation::{canonical_general_network_flownet, GENERAL_NETWORK_FLOWNET_NAME};
#[allow(unused_imports)]
pub use instance::{
...
pub use verification::{
    ...
    primary_reference_instance_matches_serial_case, validate_general_network_flownet_structure,
