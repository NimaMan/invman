...
use crate::problems::multi_echelon::general_network::finite_horizon_dp::{
    evaluate_named_heuristic, solve_optimal_policy,
};
use crate::problems::multi_echelon::general_network::heuristics::pairwise_base_stock_requests;
...
use crate::problems::multi_echelon::general_network::verification::fixtures::WORKED_TRANSITION_CASE;
use crate::problems::multi_echelon::general_network::verification::literature_benchmarks::literature_benchmark_summary;

fn build_graph(
    num_nodes: usize,
    source_nodes: &[bool],
    node_modes: &[crate::problems::multi_echelon::general_network::env::NetworkNodeMode],
    external_supplier_lead_times: &[usize],
    edges: &[crate::problems::multi_echelon::general_network::env::NetworkEdge],
