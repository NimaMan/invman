...
```bash
python autoresearch/dual_sourcing_policy_search/run_factor_screen.py
```
...
```bash
python autoresearch/dual_sourcing_policy_search/summarize_factor_screen.py
```

The summary lands in:

- `autoresearch/dual_sourcing_policy_search/factor_screen_results.md`
